                ...
                <div class="card mb-4">
                    <div class="card-body p-4">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-9">
                                <p class="text-muted mb-0">{{ $data->darah }}</p>
                            </div>
                        </div>
                        <hr class="mb-3 mt-3">
                        <div class="row">
                            ...
                            <div class="col-sm-9">
                                <p class="text-muted mb-0">
                                    <strong>Nama Ayah : </strong> {{ $data->ayah }}
                                </p>
                                <p class="text-muted mb-0">
                                    <strong>Nama Ibu &nbsp &nbsp: </strong> {{ $data->ibu }}
                                </p>
                            </div>
                        </div>
                        <hr class="mb-3 mt-3">
                        <div class="row">
                            ...
                            <div class="col-sm-9">
                                <p class="text-muted mb-0">{{ $data->riwaya_penyakit }}</p>
                            </div>
                        </div>
                    </div>
                </div>
